...
4. **`04_experimental_design_toolkit.ipynb`** — turns a reachability verdict into a runnable
 ...
 experimental-design toolkit section of [Technical Dossier — Part 1 (Results)](../docs/Technical_Dossier.md).
 ...
 **L5** achievable ceiling, **L2** per-recipe additivity reliability, **L1** synthetic certificate
 ...
 Summary in [Technical Dossier — Appendix C (Reinforcement Analyses)](../docs/Technical_Dossier.md).
7. **`07_cross_celltype_transfer.ipynb`** — cross-cell-type robustness. Uses the CZI Virtual Cell
 ...
 Summary in [Technical Dossier — Appendix B (Cross-Cell-Type Transfer)](../docs/Technical_Dossier.md).
 ...
 **A6** signed construct validity, **A4** weak-instrument-robust recipe intervals, and the **A2**
 ...
 [Technical Dossier — Part 4 (Trust & Causal Inference)](../docs/Technical_Dossier.md).
