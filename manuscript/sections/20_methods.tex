...
the target by the sign of each coordinate's required change; the \emph{one-sided}
...
Two distinct null models guard against two distinct failure modes, and we are explicit about
which each addresses.
...
in-sample value of $0.627$; the gap is the honest cost of generalization, and we quote the
